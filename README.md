...
[![NPM version](https://img.shields.io/npm/v/@lifeondesk/foundry)](https://www.npmjs.com/package/@lifeondesk/foundry) [![Code coverage](https://img.shields.io/codecov/c/github/lifeondesk/foundry)](https://codecov.io/gh/lifeondesk/foundry) [![License](https://img.shields.io/github/license/lifeondesk/foundry)](https://github.com/lifeondesk/foundry/blob/main/LICENSE) [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v2.1%20adopted-ff69b4.svg)](CODE_OF_CONDUCT.md)
...
Built 99% on top of [@sumup/foundry](https://www.npmjs.com/package/@lifeondesk/foundry) so they get 99% of the credit.   
I wanted to add my 1% personal touch.
...
```sh
# With npm
$ npm install --save-dev @lifeondesk/foundry

# With Yarn v1
$ yarn add --dev @lifeondesk/foundry
```
...
```js
module.exports = require('@lifeondesk/foundry/<tool>')(overrides);
